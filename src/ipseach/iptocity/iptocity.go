...
func (this IpInfo) String() string {
	return strconv.FormatInt(this.CityId, 10) + "|" + this.Country + "|" + this.Region + "|" + this.Province + "|" + this.City + "|" + this.ISP
}
...
func New(path string) (*Iptocity, error) {
...
func (this *Iptocity) Close() {
	this.dbFileHandler.Close()
}

func (this *Iptocity) MemorySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
...
func (this *Iptocity) BinarySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	if this.totalBlocks == 0 {
...
func (this *Iptocity) BtreeSearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	ip, err := ip2long(ipStr)
